#!/usr/bin/env python
"""
Starter Script - Two Camera Poses Processing (p-15_y-10_r+0 and p-5_y+0_r+0)
============================================================================
Generated: 20260114
Script: BatchedDB
Mode: Multiple poses with identifiable outputs
...
def process_single_pose(model, base_path, pose_folder, batch_size, overlap, matching_strategy):
    ...
    # Sanitize pose name for filename (e.g., "p-15_y-10_r+0" -> "pm15_ym10_rp0")
...
if __name__ == "__main__":
    ...
    # Configuration
    BASE_PATH = Path("/d_disk/_DataBuffer/RopeCap/20251224_103638/parsed_data/undistort_fov110_720sq_final/cam1")
    POSE_FOLDERS = [
        "p-15_y-10_r+0",
        "p-5_y+0_r+0"
    ]
    ...
    print(f"{'=' * 80}")
    print(f"STARTER - TWO POSES PROCESSING")
    print(f"{'=' * 80}")
