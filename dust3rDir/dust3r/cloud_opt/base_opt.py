...
from dust3rDir.dust3r.utils.geometry import inv, geotrf
from dust3rDir.dust3r.utils.device import to_numpy
from dust3rDir.dust3r.utils.image import rgb
from dust3rDir.dust3r.viz import SceneViz, segment_sky, auto_cam_size
from dust3rDir.dust3r.optim_factory import adjust_learning_rate_by_lr

from dust3rDir.dust3r.cloud_opt.commons import (edge_str, ALL_DISTS, NoGradParamDict, get_imshapes, signed_expm1, signed_log1p,
...
class BasePCOptimizer (nn.Module):
    ...
    def _init_from_views(self, view1, view2, pred1, pred2,
        ...
        # TODO: add a config, which is hidden, to allow for the conf to be trainable
    ...
    def compute_global_alignment(self, init=None, niter_PnP=10, **kw):
        from dust3rDir.dust3r.cloud_opt import init_im_poses as init_fun
        if init is None:
            pass
